...
import { isEnterKeyPress, isEscapeKeyPress } from '@app/events/utils';

// Internal Components
import Input from '@app/components/input/input';
import { AbstractInputProps, AbstractInputHandle, HTMLAbstractInputElement } from '@app/components/input/peripherals';
import Modal, { ModalHeader, ModalContent, ModalHandle } from '@app/components/modal';
...
import documentationIcon from '@images/documentation-icon.svg';
...
function SearchBar(props: SearchBarProps, ref: React.ForwardedRef<SearchBarHandle>): React.JSX.Element {
    ...
    return (
        <div id={`${props.id}Container`} className={props.className}>
            ...
            <Modal ref={modalRef} id={`${props.id}-modal`} title='Search Documentation' onCancel={hideModal}>
                <ModalHeader>
